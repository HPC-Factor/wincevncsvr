 ...
 * translate.c, each time with a different definition of the macro BITSOUT.
 * For each value of BITSOUT, this file defines two functions for initialising
...
#define SwapOUT(x) CONCAT2E(Swap,BITSOUT) (x)
#define rfbInitTrueColourSingleTableOUT \
				CONCAT2E(rfbInitTrueColourSingleTable,BITSOUT)
#define rfbInitTrueColourRGBTablesOUT CONCAT2E(rfbInitTrueColourRGBTables,BITSOUT)
#define rfbInitOneRGBTableOUT CONCAT2E(rfbInitOneRGBTable,BITSOUT)
